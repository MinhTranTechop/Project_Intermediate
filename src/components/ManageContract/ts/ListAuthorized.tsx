...
import '../css/ListAuthorized.css'
import piSearch from '../../../assets/Search icon.png'
import piDrop from '../../../assets/u_angle-down.png'
import btnAdd from '../../../assets/u_plus.png'
import Sidebar from '../../bars/ts/Sidebar'
...
const ListAuthorized = () => {
  ...
  return (
    ...
    <div className="ListEq_form">
      ...
      <Link className="link-nav" to="/AddAuthorizedContract">
